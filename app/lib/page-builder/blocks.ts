...
export const DEFAULT_BLOCKS: PBBlock[] = [
  ...
  },
  {
    ...
    content: `<section data-pb-name="Section" class="py-12 px-8"><h2 data-pb-name="Heading" class="text-2xl font-bold mb-4">Section Title</h2><p data-pb-name="Text" class="text-gray-600">Section content goes here.</p></section>`,
  },
  {
    id: "hero",
    label: "Hero",
    ...
    content: `<section data-pb-name="Hero" class="py-16 px-8 text-center bg-gray-50"><h1 data-pb-name="Heading" class="text-4xl font-bold mb-4">Hero Title</h1><p data-pb-name="Text" class="text-lg text-gray-500 max-w-xl mx-auto mb-8">A compelling description that draws readers in.</p><a data-pb-name="Button" href="#" class="inline-block px-6 py-3 bg-indigo-500 text-white rounded-lg font-medium no-underline">Get Started</a></section>`,
  },
  {
    id: "two-cols",
    label: "2 Columns",
    ...
    content: `<div data-pb-name="2 Columns" class="flex gap-8 p-8"><div data-pb-name="Column" class="flex-1"><h3 data-pb-name="Heading" class="text-xl font-semibold mb-2">Column 1</h3><p data-pb-name="Text" class="text-gray-600">Content here.</p></div><div data-pb-name="Column" class="flex-1"><h3 data-pb-name="Heading" class="text-xl font-semibold mb-2">Column 2</h3><p data-pb-name="Text" class="text-gray-600">Content here.</p></div></div>`,
  },
  {
    id: "three-cols",
    label: "3 Columns",
    ...
    content: `<div data-pb-name="3 Columns" class="flex gap-8 p-8"><div data-pb-name="Column" class="flex-1"><h3 data-pb-name="Heading" class="text-xl font-semibold mb-2">Col 1</h3><p data-pb-name="Text" class="text-gray-600">Content.</p></div><div data-pb-name="Column" class="flex-1"><h3 data-pb-name="Heading" class="text-xl font-semibold mb-2">Col 2</h3><p data-pb-name="Text" class="text-gray-600">Content.</p></div><div data-pb-name="Column" class="flex-1"><h3 data-pb-name="Heading" class="text-xl font-semibold mb-2">Col 3</h3><p data-pb-name="Text" class="text-gray-600">Content.</p></div></div>`,
  },
  {
    id: "nav",
    label: "Navbar",
    ...
    content: `<nav data-pb-name="Navbar" class="flex items-center justify-between px-8 py-4 border-b border-gray-200"><span data-pb-name="Brand" class="text-xl font-bold">Brand</span><div data-pb-name="Nav Links" class="flex gap-6"><a data-pb-name="Link" href="#" class="text-gray-600 no-underline text-sm">Features</a><a data-pb-name="Link" href="#" class="text-gray-600 no-underline text-sm">Pricing</a><a data-pb-name="Link" href="#" class="text-gray-600 no-underline text-sm">About</a><a data-pb-name="Button" href="#" class="px-4 py-1.5 bg-indigo-500 text-white rounded-lg text-sm no-underline">Sign Up</a></div></nav>`,
  },
  {
    id: "footer",
    label: "Footer",
    ...
    content: `<footer data-pb-name="Footer" class="bg-gray-900 text-gray-400 py-12 px-8"><div data-pb-name="Row" class="flex gap-12 mb-8"><div data-pb-name="Column"><h4 data-pb-name="Heading" class="text-white font-semibold mb-3 text-sm">Product</h4><ul data-pb-name="List" class="space-y-2 text-sm list-none p-0"><li><a data-pb-name="Link" href="#" class="text-gray-400 no-underline">Features</a></li><li><a data-pb-name="Link" href="#" class="text-gray-400 no-underline">Pricing</a></li></ul></div><div data-pb-name="Column"><h4 data-pb-name="Heading" class="text-white font-semibold mb-3 text-sm">Company</h4><ul data-pb-name="List" class="space-y-2 text-sm list-none p-0"><li><a data-pb-name="Link" href="#" class="text-gray-400 no-underline">About</a></li><li><a data-pb-name="Link" href="#" class="text-gray-400 no-underline">Contact</a></li></ul></div></div><p data-pb-name="Text" class="text-sm border-t border-gray-800 pt-6">Made with Stencil CMS</p></footer>`,
  },
  {
    id: "container",
    label: "Container",
  ...
  // Basic
  {
    ...
    content: `<h2 data-pb-name="Heading" class="text-2xl font-bold">Heading</h2>`,
  },
  {
    id: "paragraph",
    label: "Paragraph",
    ...
    content: `<p data-pb-name="Text" class="text-base text-gray-600">Insert your text here.</p>`,
  },
  {
    id: "link",
    label: "Link",
    ...
    content: `<a data-pb-name="Link" href="#" class="text-indigo-500 underline">Link text</a>`,
  },
  {
    id: "image",
    label: "Image",
  ...
  },
  {
    ...
    content: `<a data-pb-name="Button" href="#" class="inline-block px-6 py-3 bg-indigo-500 text-white rounded-lg font-medium no-underline">Button</a>`,
  },
  {
    id: "divider",
    label: "Divider",
    ...
    content: `<hr data-pb-name="Divider" class="border-t border-gray-200 my-8" />`,
  },
  {
    id: "spacer",
    label: "Spacer",
  ...
  },
  {
    ...
    content: `<div data-pb-name="Video" class="aspect-video bg-gray-900 rounded-lg flex items-center justify-center"><span class="text-gray-500">Video Embed</span></div>`,
  },
  ...
  // Components
  {
    ...
    content: `<div data-pb-name="Card" class="border border-gray-200 rounded-lg overflow-hidden max-w-sm"><div data-pb-name="Card Image" class="h-44 bg-gray-100"></div><div data-pb-name="Card Body" class="p-5"><h3 data-pb-name="Heading" class="font-semibold mb-2">Card Title</h3><p data-pb-name="Text" class="text-gray-500 text-sm">Card description goes here.</p></div></div>`,
  },
  {
    id: "testimonial",
    label: "Testimonial",
    ...
    content: `<div data-pb-name="Testimonial" class="bg-gray-50 rounded-xl p-8 max-w-lg mx-auto text-center"><p data-pb-name="Quote" class="text-gray-600 italic mb-4">"This is an amazing product that changed how we work."</p><p data-pb-name="Author" class="font-semibold text-sm">Jane Doe</p><p data-pb-name="Role" class="text-gray-400 text-xs">CEO, Company</p></div>`,
  },
  {
    id: "pricing",
    label: "Pricing Card",
    ...
    content: `<div data-pb-name="Pricing Card" class="border border-gray-200 rounded-xl p-8 max-w-xs text-center"><h3 data-pb-name="Plan Name" class="text-lg font-semibold mb-1">Pro Plan</h3><p data-pb-name="Description" class="text-gray-400 text-sm mb-4">For growing teams</p><p data-pb-name="Price" class="text-4xl font-bold mb-6">$49<span class="text-base font-normal text-gray-400">/mo</span></p><ul data-pb-name="Features" class="text-sm text-gray-600 space-y-2 mb-8 text-left list-none p-0"><li>Unlimited projects</li><li>Priority support</li><li>Advanced analytics</li></ul><a data-pb-name="Button" href="#" class="block w-full py-2.5 bg-indigo-500 text-white rounded-lg font-medium no-underline text-center">Get Started</a></div>`,
  },
];
